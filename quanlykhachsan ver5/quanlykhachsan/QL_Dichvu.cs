...
namespace quanlykhachsan
{
    public partial class QL_Dichvu : Form
    {
        ...
        private void ketnoi()
        {
            try
            {
                SqlConnection kn2 = new SqlConnection(@"Data Source=tunguyen;Initial Catalog=quanlykhachsandemo2304;Integrated Security=True");
                kn2.Open();
...
VALUES (N'" + txtMadv.Text + @"',N'" + txtTendv.Text + @"',N'" + txtDonvitinh.Text + @"',N'" + txtGiadv.Text + @"')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                SqlConnection kn2 = new SqlConnection(@"Data Source=ADMINISTRATOR\SQLEXPRESS;Initial Catalog=quanlykhachsandemo2304;User ID=sa");
                kn2.Open();

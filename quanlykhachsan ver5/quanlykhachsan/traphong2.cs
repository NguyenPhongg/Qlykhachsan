...
{
    public partial class traphong2 : Form
    {
        public traphong2()
        {
            InitializeComponent();
        ...
        private void ketnoi1()
        {
            try
            {
                SqlConnection kn1 = new SqlConnection(@"Data Source=tunguyen;Initial Catalog=quanlykhachsandemo2304;Integrated Security=True");
                kn1.Open();
...
WHERE (tbl_phieuthuephong.MAPHIEUTHUE=N'" + txtMaphieu.Text + @"')";
        ...
        public void ketnoi()
        {
            try
            {
                if (cn.State == 0)
                {
                    cn.ConnectionString = @"Data Source=tunguyen;Initial Catalog=quanlykhachsandemo2304;Integrated Security=True";
                    cn.Open();
                }
            }
            catch (Exception ex)
...
WHERE (tbl_phieuthuephong.MAPHIEUTHUE=N'" + txtMaphieu.Text + @"')";
        ...
        private void dgvPhong_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                SqlConnection kn = new SqlConnection(@"Data Source=tunguyen;Initial Catalog=quanlykhachsandemo2304;Integrated Security=True");
                kn.Open();
                string sql = "select a.MAPHONG, a.GIAPHONG from tbl_phong a";
